#!/usr/bin/env bash
# =====================================================================
#  bootstrap (oneshot) - Inicializa estado persistente del add-on:
#    1. SSH keypair en /data/.ssh
...
# Pubkey accesible desde /config (asumiendo map config:rw)
if [ -d /config ]; then
...
# AUTO-GENERATED by s6-rc bootstrap on add-on start
